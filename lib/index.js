...
var Buttonx = (_temp = _class = function (_PureComponent) {
    _inherits(Buttonx, _PureComponent);

    function Buttonx() {
        _classCallCheck(this, Buttonx);

        return _possibleConstructorReturn(this, (Buttonx.__proto__ || Object.getPrototypeOf(Buttonx)).apply(this, arguments));
    }

    _createClass(Buttonx, [{
        key: 'render',
    ...
    // This prop will be set automatically when the Buttonx is used inside a Dropdown.
...
exports.ButtonxToolbar = exports.ButtonxGroup = exports.Buttonx = undefined;
...
exports.Buttonx = _Button3.default;
exports.ButtonxGroup = _ButtonGroup3.default;
exports.ButtonxToolbar = _ButtonToolbar3.default;
...
var ButtonxGroup = function ButtonxGroup(_ref) {
    var _classes;
...
ButtonxGroup.propTypes = {
    btnSize: _propTypes2.default.oneOf(_constants.btnSizes),
    btnStyle: _propTypes2.default.oneOf(_constants.btnStyles),
    vertical: _propTypes2.default.bool,

    // Apply styles for use in a Dropdown.
    // This prop will be set automatically when the ButtonxGroup is used inside a Dropdown.
    dropdownOpen: _propTypes2.default.bool
};
ButtonxGroup.defaultProps = {
    vertical: false,
    dropdownOpen: false
};

exports.default = ButtonxGroup;
...
var ButtonxToolbar = function ButtonxToolbar(_ref) {
...
exports.default = ButtonxToolbar;
